...
public class testActivity extends Activity {
    ...
    int e_percent, i_percent, s_percent, n_percent, t_percent, f_percent, j_percent, p_percent = 0;
    ...
    public void next1() {
        ...
        if (inspection_number == 9) {
            e_percent = (int)(e_point*12.5);
            i_percent = 100 - e_percent;
            s_percent = (int)(s_point*12.5);
            n_percent = 100 - s_percent;
            t_percent = (int)(t_point*12.5);
            f_percent = 100 - t_percent;
            j_percent = (int)(j_point*12.5);
            p_percent = 100 - j_percent;

            if(mbti_result.equals("enfj")) {
                Intent intent = new Intent(testActivity.this, enfj_res.class;
            }
            elif(mbti_result.equals("enfp")) {
                Intent intent = new Intent(testActivity.this, enfp_res.class;
            }
            elif(mbti_result.equals("entj")) {
                Intent intent = new Intent(testActivity.this, entj_res.class;
            }
            elif(mbti_result.equals("entp")) {
                Intent intent = new Intent(testActivity.this, entp_res.class;
            }
            elif(mbti_result.equals("esfj")) {
                Intent intent = new Intent(testActivity.this, esfj_res.class;
            }
            elif(mbti_result.equals("esfp")) {
                Intent intent = new Intent(testActivity.this, esfp_res.class;
            }
            elif(mbti_result.equals("estj")) {
                Intent intent = new Intent(testActivity.this, estj_res.class;
            }
            elif(mbti_result.equals("estp")) {
                Intent intent = new Intent(testActivity.this, estp_res.class;
            }
            elif(mbti_result.equals("infj")) {
                Intent intent = new Intent(testActivity.this, infj_res.class;
            }
            elif(mbti_result.equals("infp")) {
                Intent intent = new Intent(testActivity.this, infp_res.class;
            }
            elif(mbti_result.equals("intj")) {
                Intent intent = new Intent(testActivity.this, intj_res.class;
            }
            elif(mbti_result.equals("intp")) {
                Intent intent = new Intent(testActivity.this, intp_res.class;
            }
            elif(mbti_result.equals("isfj")) {
                Intent intent = new Intent(testActivity.this, isfj_res.class;
            }
            elif(mbti_result.equals("isfp")) {
                Intent intent = new Intent(testActivity.this, isfp_res.class;
            }
            elif(mbti_result.equals("istj")) {
                Intent intent = new Intent(testActivity.this, istj_res.class;
            }
            elif(mbti_result.equals("istp")) {
                Intent intent = new Intent(testActivity.this, istp_res.class;
            }
            intent.putExtra("e_percent", e_percent);
            intent.putExtra("i_percent", e_percent);
            intent.putExtra("s_percent", e_percent);
            intent.putExtra("n_percent", e_percent);
            intent.putExtra("t_percent", e_percent);
            intent.putExtra("f_percent", e_percent);
            intent.putExtra("j_percent", e_percent);
            intent.putExtra("p_percent", e_percent);
